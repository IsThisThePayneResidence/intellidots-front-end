...
import { IDdlLogMessage, IBsRule } from '../../../../../resourcesInterfaces'
...
function mapState(state: IStore, ownProps: IOwnProps) {
  let columns: IColumnProps[] =  [{
    key: _prop((o: IDdlLogMessage) => o.timeStamp),
    title: "Date and time",
    render: TimeCell,
    filterComponent: <RangeDateFilter/>,
    sortFunction: (i1: IDdlLogMessage, i2: IDdlLogMessage) => compareTimeStamp(i1.timeStamp, i2.timeStamp),
  }, {
    key: _prop((o: IDdlLogMessage) => o.type),
    title: "Type",
  }, {
    key: _prop((o: IDdlLogMessage) => o.message),
    title: "Message",
  },
  ]
  ...
  let tableProps: IFlexTableHandlerComponentProps = {
    ...
    columns,
    displayData: state.entity.bsLogMessages.logMessages.filter(message => message.ruleId == ownProps.rule.id),
  }
  return tableProps
}
